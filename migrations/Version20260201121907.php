 ...
 */
final class Version20260201121907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE academy_video ADD video_filename VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE academy_video ADD thumbnail_filename VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE academy_video DROP youtube_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE academy_video ADD youtube_id VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE academy_video DROP video_filename');
