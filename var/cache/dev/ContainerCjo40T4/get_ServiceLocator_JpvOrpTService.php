...
class get_ServiceLocator_JpvOrpTService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.jpvOrpT'])) {
            return $container->privates['.service_locator.jpvOrpT'];
        }

        return $container->privates['.service_locator.jpvOrpT'] = $instance;
    }
}
